...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static Vector3 GetMouseWorldPosition() {
            Vector3 vec = GetMouseWorldPositionWithZ(UnityEngine.Input.mousePosition, Camera.main);
            vec.z = 0f;
            return vec;
        }
        public static Vector3 GetMouseWorldPositionWithZ() {
            return GetMouseWorldPositionWithZ(UnityEngine.Input.mousePosition, Camera.main);
        }
        ...
        public static FunctionUpdater CreateMouseClickFromToAction(int mouseButton, int cancelMouseButton, Action<Vector3, Vector3> onMouseClickFromTo, Action<Vector3, Vector3> onWaitingForToPosition) {
            ...
            return FunctionUpdater.Create(() => {
                ...
                if (state == 1 && UnityEngine.Input.GetMouseButtonDown(cancelMouseButton)) {
                    // Cancel
                    state = 0;
                }
                if (UnityEngine.Input.GetMouseButtonDown(mouseButton) && !UtilsClass.IsPointerOverUI()) {
                    if (state == 0) {
                        state = 1;
        ...
        public static Vector3 GetWorldPositionFromUIZeroZ() {
            Vector3 vec = GetWorldPositionFromUI(UnityEngine.Input.mousePosition, Camera.main);
            vec.z = 0f;
            return vec;
        }
        ...
        public static Vector3 GetWorldPositionFromUI() {
            return GetWorldPositionFromUI(UnityEngine.Input.mousePosition, Camera.main);
        }

        public static Vector3 GetWorldPositionFromUI(Camera worldCamera) {
            return GetWorldPositionFromUI(UnityEngine.Input.mousePosition, worldCamera);
        }
        ...
        public static Vector3 GetWorldPositionFromUI_Perspective() {
            return GetWorldPositionFromUI_Perspective(UnityEngine.Input.mousePosition, Camera.main);
        }

        public static Vector3 GetWorldPositionFromUI_Perspective(Camera worldCamera) {
            return GetWorldPositionFromUI_Perspective(UnityEngine.Input.mousePosition, worldCamera);
        }
